    ...
    <div className="home-wrapper">
      <div className="home-content">
        ...
        <div className="home-text">
          ...
          <p>
            I'm a 3rd year student currently majoring in Computer Science - Artificial Intelligence 
            with a minor in Economics at McGill University. My strongest area of development is in 
            Full-stack web development, with a focus on back-end scripting. I'm currently seeking 
            full time internships or part-time employment opportunities in software development roles!
          </p>
          <div className="button-container">
            ...
            <a href="/resume/resume.pdf" className="button" target="_blank" rel="noopener noreferrer">
              <img src="https://upload.wikimedia.org/wikipedia/commons/8/87/PDF_file_icon.svg" alt="Resume Icon" />
              Resume
            </a>
          </div>
        </div>
